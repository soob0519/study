    ...
    <body>
        ...
        <section class="sub">
            <div class="navi2 sub_center">
                ...
                <ul class="tab_menu">
                    <li>
                       <a href="goodsList.do" class="on">제품 검색</a>
                    </li>
                    <li>
                        <a href="goodsList.do">신제품</a> 
                    </li>
                    <li>
                    	<a href="goodsList.do">전문의약품</a> 
                    </li>
                    <li>
                    	<a href="goodsList.do">일반의약품</a> 
                    </li>
                    <li>
                    	<a href="goodsList.do">건강기능식품</a> 
                    </li>
                </ul>
            </div>
            <div class="content">
                            ...
                            <div class="product_list" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">
                                ...
                                <div class="pro_wrap">
                                    ...
                                    <ul class="pro_item fix_flexbetween">
                                        ...
                                        <li>
                                            <a href="#none"><img src="images/product_img03.png" alt="메녹틸"></a>
                                            <div class="pro_item_text">
                                                <p>전문의약품</p>
                                        ...
                                        <li>
                                            <a href="#none"><img src="images/product_img04.png" alt="활명수"></a>
                                            <div class="pro_item_text">
                                                <p>일반의약품</p>
                                        ...
                                        <li>
                                            <a href="#none"><img src="images/product_img05.png" alt="터치메드"></a>
                                            <div class="pro_item_text">
                                                <p>신제품</p>
                                        ...
                                        <li>
                                            <a href="#none"><img src="images/product_img06.png" alt="판콜"></a>
                                            <div class="pro_item_text">
                                                <p>일반의약품</p>
                                                <h3>판콜 PANCOLD</h3>
                                            </div>
