...
public class EgovSampleController {
	...
	public String deptSave(DeptVO vo) throws Exception {
		int result = sampleService.insertDept(vo);
	...
	public String deptList(ModelMap model) throws Exception{
		
		int total = sampleService.selectDeptTotal();
