...
function fn_userid() {
	...
	location="loginChk1.jsp?userid="+userid;
}
 ...
 <body>
	...
	<form name="frm" method="post" action="loginMemberWriteSave.jsp">
	<div class="div_main">
	...
	<table class="table1">
		...
		<tr>
			...
			<td>
				...
				&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="gender" value="M"> <span style="font-size:12px;">남</span>
				<input type="checkbox" name="gender" value="F"> <span style="font-size:12px;">여</span>
				<br>
