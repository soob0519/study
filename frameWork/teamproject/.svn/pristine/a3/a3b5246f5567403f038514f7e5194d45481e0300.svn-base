...
<!-- 수정처리 할 SQL 작성 및 적용 -->
<%
String sql = "SELECT title,writer,content,to_char(rdate,'yyyy.mm.dd') rdate,hits FROM board2 WHERE unq='"+unq+"'";
...
function fn_submit() {
 ...
 <body>
	...
	<section>
		...
		<form name="frm" method="post" action="boardModifySave.jsp?code=<%=code%>">
