...
<ul class="menu_ul">
	...
	<li class="menu_li"><a href="../customer/scheduleList.jsp">예약현황</a></li>
	<li class="menu_li"><a href="../customer/boardList.jsp?code=1">리뷰</a></li>
	<li class="menu_li"><a href="../customer/boardList.jsp?code=2">Q&A</a></li>
	<%
