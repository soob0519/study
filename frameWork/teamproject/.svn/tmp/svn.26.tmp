...
String sql =" SELECT DAY,COUNT(DAY) AS CNT1 FROM ("
		   ...
		   +" FROM SCHEDULE WHERE STID='"+SessionUserid+"' "		// 가게 아이디
...
<!--  <script src="../include/jquery-3.7.1.js"></script>	 ajax 사용하기 위한 소스(로컬화) -->
  
 <link rel="stylesheet" href="../../css/scheduleListST.css"/>  <!-- 외부 css파일 불러오는 태그 -->
 </head>
		...
		<div>
			<table>
				<tr>
					...
					<th><a href="../store/storeInfo.jsp">가게정보관리</a></th>
					<th><a href="../store/notice.jsp">공지관리</a></th>
					<th><a href="../store/menu.jsp">메뉴관리</a></th>
					<th><a href="../store/scheduleListST.jsp">예약현황</a></th>
					<th><a href="../store/boardListST.jsp?code=1">리뷰</a></th>
					<th><a href="../store/boardListST.jsp?code=2">Q&A</a></th>
					<%
...
<section>
	...
	<form name="frm3" method="post" action="scheduleListST.jsp">
	<table class="table1">
		<tr>
