...
function fn_userid() {
	...
	location="loginChk2.jsp?userid="+userid;
}
 ...
 function fn_submit() {
	...
	if (document.frm.rkind.value == "") {
		alert("업종을 입력하세요.");	
		document.frm.rkind.focus();
		return false;
	}
 ...
 <body>
	...
	<form name="frm" method="post" action="loginMemberWriteSave2.jsp">
	<div class="div_main">
	...
	<table class="table1">
		...
		<tr>
			<td style="font-size:11px;"><b>상호명</b><img src="../images/check.PNG" style="width:12px;"></td>
			<td>
				<input type="text" name="rname" class="input1">
				<span style="font-size:11px; margin-left:10px;"> </span>
			</td>
		</tr>
		<tr>
			<td colspan="2"> <hr> </td>
		...
		<tr>
			<td style="font-size:11px;"><b>업종</b><img src="../images/check.PNG" style="width:12px;"></td>
			<td>
				<input type="text" name="rkind" class="input1">
				<span style="font-size:10px; margin-left:10px;"> 해당 업종을 입력해주세요</span>
			</td>
		</tr>
		<tr>
			<td colspan="2"> <hr> </td>
		...
		<tr>
			<td style="font-size:11px;"><b>지역(시/도)</b><img src="../images/check.PNG" style="width:12px;"></td>
			<td>
				<input type="text" name="addr" class="input1">
				<span style="font-size:10px; margin-left:10px;"> 지역(시/도)을 입력해주세요</span>
			</td>
		</tr>
		<tr>
			<td colspan="2"> <hr> </td>
		...
		<tr>
			<td style="font-size:11px;"><b>이메일수신여부</b></td>
			<td>
		...
		<tr>
			<td style="font-size:11px;"><b>SMS수신여부</b></td>
			<td>
				<input type="checkbox" name="chk1" checked>
					<span style="font-size:12px;"> 수신함</span>
				&nbsp;&nbsp;
		...
		<div class="div_btn">
			<button type="button" class="btn2"><a href="/main.jsp">취소</a></button>
			<button type="button" class="btn3" onclick="fn_submit();return false;"><a href="/main.jsp">회원가입</a></button>
