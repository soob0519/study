...
<%
if(gubun.equals("1")){
	String sql1 = "INSERT INTO board2(unq,title,pass,writer,content,gubun,rdate,hits,lev,stid)"
	...
	String sql1 = "INSERT INTO board2(unq,title,pass,writer,content,gubun,rdate,hits,stid)"
