...
public interface EgovSampleService {
	...
	int insertDept(DeptVO vo) throws Exception;
	int updateDept(DeptVO vo) throws Exception;
	int deleteDept(String deptno) throws Exception;
	
	List<?> selectDeptList() throws Exception;
	
	int selectDeptTotal() throws Exception;
	
	DeptVO selectDeptDetail(String deptno) throws Exception;
	//	DeptVo에 탑재해서 정보를 받을거라
