  ...
  <section>
	...
	<div class="div_agrees">
		...
		<div style="margin-top:10px; text-align:center;">
			<button type="button" class="button4">수정</button>
			<button type="button" class="button4">삭제</button>
			<button type="button" class="button4" onclick="location='boardList.jsp'">목록</button>
